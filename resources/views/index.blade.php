                                        ...
                                        <form method="post" name="enq">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div>
                                                        <img id="showImage" src="{{!empty($userdata->image) ? url('upload/user_image/'.$userdata->image) : url('upload/no_image.jpg')}}" alt="user image" class="rounded-circle p-1 bg-primary" width="110">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
