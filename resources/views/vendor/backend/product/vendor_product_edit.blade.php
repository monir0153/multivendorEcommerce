...
<div class="page-content">
  ...
  <div class="card">
      <div class="card-body p-4">
          ...
          <hr>
          <form action="{{route('vendor.update.product',$products->id)}}" id="myForm" method="POST" enctype="multipart/form-data">
            @csrf
  ...
  <div class="card">
    <div class="card-body">
        ...
        <form action="{{route('update.vendor.product.multiimage',$products->id)}}" id="myForm" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('vendor.product.multiimage.delete',$image->id)}}" class="btn btn-danger" id="delete">Delete</a>
