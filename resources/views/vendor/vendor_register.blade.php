							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center">
										<h3 class="">Vendor Register</h3>
										<p>Already have an account?<a href="{{url('vendor/login')}}">Sign in here</a>
										</p>
									</div>
									...
									<div class="form-body">
										<form class="row g-3" method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="col-12">
												...
												<input type="text" name="username" class="form-control" :value="old('username')"  placeholder="Full Name">
                                                @error('username')
                                                    <span class="text-danger">{{$message}}</span>
                                                @enderror
											</div>
                                            ...
                                            <div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" name="password_confirmation" placeholder="Confirm Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
