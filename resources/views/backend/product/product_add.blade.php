                ...
                <div class="col-lg-8">
                    <div class="border border-3 p-4 rounded">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="product_color" class="form-control visually-hidden" data-role="tagsinput" value="red,green,black">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <img src="" class="pt-3 pb-3" id="mainThumb" width="200px">
                          </div>
                          <div class="mb-3">
