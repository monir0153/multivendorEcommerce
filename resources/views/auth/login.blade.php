...
<head>
    <meta charset="utf-8" />
    <title>Login - E-commerce Online Shop</title>
                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="email" id="email" :value="old('email')" required="" name="email" autofocus autocomplete="username" placeholder="Username or Email *" />
                                                @error('email')
